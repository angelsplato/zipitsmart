package zw.co.zimswitch.web.rest;

import zw.co.zimswitch.ZipitSmartApp;
import zw.co.zimswitch.config.Constants;
import zw.co.zimswitch.domain.User;
import zw.co.zimswitch.repository.AuthorityRepository;
import zw.co.zimswitch.repository.UserRepository;
import zw.co.zimswitch.security.AuthoritiesConstants;
import zw.co.zimswitch.service.UserService;
import zw.co.zimswitch.service.dto.PasswordChangeDTO;
import zw.co.zimswitch.service.dto.UserDTO;
import zw.co.zimswitch.web.rest.vm.KeyAndPasswordVM;
import zw.co.zimswitch.web.rest.vm.ManagedUserVM;
...
import static zw.co.zimswitch.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = ZipitSmartApp.class)

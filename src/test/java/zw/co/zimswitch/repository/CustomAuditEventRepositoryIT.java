package zw.co.zimswitch.repository;

import zw.co.zimswitch.ZipitSmartApp;

import zw.co.zimswitch.config.Constants;
import zw.co.zimswitch.config.audit.AuditEventConverter;
import zw.co.zimswitch.domain.PersistentAuditEvent;
...
import static zw.co.zimswitch.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
